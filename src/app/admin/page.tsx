            ...
            <div className="space-y-8">
              <section className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm">
                ...
                <div className="space-y-6">
                  <div>
                    <label className="block text-sm font-bold text-slate-700 mb-2">Nom du Site (Onglet navigateur)</label>
                    <input 
                      type="text" 
                      ...
                      placeholder="Exotics 3 Frontières"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-bold text-slate-700 mb-2">Favicon (Icône d'onglet)</label>
                    <div className="flex gap-2">
                      <input 
                        type="text" 
                        value={config.general?.faviconUrl || ""}
                        onChange={(e) => setConfig({...config, general: {...(config.general || {}), faviconUrl: e.target.value}})}
                        ...
                        placeholder="URL de l'image (format .ico ou .png)"
                      />
                      <label className="cursor-pointer bg-slate-100 hover:bg-slate-200 px-4 py-2 rounded-xl flex items-center gap-2 transition-colors">
                        ...
                        <input 
                          ...
                          onChange={(e) => handleImageUpload(e, (url) => setConfig({
                            ...config, 
                            general: { ...(config.general || {}), faviconUrl: url }
                          }))}
                        />
                      </label>
                    </div>
                    {config.general?.faviconUrl && (
                      <div className="mt-2 flex items-center gap-2">
                        <p className="text-xs text-slate-500 font-bold">Aperçu :</p>
                        <img src={config.general.faviconUrl} alt="Favicon" className="w-8 h-8 object-contain border border-slate-200 rounded-md" />
                      </div>
                    )}
                  </div>
                </div>
